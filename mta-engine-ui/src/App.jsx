  ...
  return (
    <>
      <style>{`
        ...
        .animate-fade { animation: fade 0.4s ease-in forwards; }
        .ticker-track {
          display: flex;
          width: max-content;
      ...
      <div className="min-h-screen bg-[#030305] text-slate-100 font-sans antialiased relative overflow-hidden selection:bg-orange-500/30">
        ...
        <div className="relative z-10 max-w-6xl mx-auto p-4 md:p-8 pt-10">
          ...
          <header className="mb-12 text-center md:text-left flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-white uppercase drop-shadow-2xl">
                Route{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-600">
                  Intelligence
                </span>
              </h1>
              <p className="text-sm text-slate-400 mt-4 font-mono max-w-xl">
                <span className="text-white">5,000-trial Monte Carlo</span> •
                Live MTA telemetry active • Butterfly-effect transfer modeling
              </p>
            </div>

            <div className="hidden md:flex items-center gap-4 text-xs font-mono text-slate-500 bg-[#0d0e15] border border-white/5 p-3 rounded-lg shadow-2xl">
          ...
          <form
            ...
            className="glass-panel p-6 rounded-2xl shadow-2xl mb-12 transform transition-all hover:border-white/10"
          >
          ...
          {results.length > 0 && (
            <div className="space-y-8 animate-slide-up">
              ...
              <div className="glass-panel rounded-2xl overflow-hidden shadow-2xl shadow-black">
                ...
                {/* Main Content Area (Keys on activeIdx to trigger fade animation on change) */}
                <div
                  key={activeRouteIdx}
